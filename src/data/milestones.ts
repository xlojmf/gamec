...
export const MILESTONES: Milestone[] = [
  ...
  { id: 'M6', title: 'Dice', detail: 'Roll animation, 7 → robber flow', status: 'next' },
  { id: 'M7', title: 'Resource production', detail: 'Yields, player hands, bank limits', status: 'todo' },
  { id: 'M8', title: 'Player turns', detail: 'boardgame.io local client, snake-draft setup, turn phases', status: 'todo' },
  { id: 'M9', title: 'Building rules', detail: 'Costs, supply, connectivity, distance rule', status: 'todo' },
  { id: 'M10', title: 'Trading', detail: 'Bank 4:1, ports, player trades', status: 'todo' },
